...
const RoleRoute = ({ children, allowedRoles }: { children: React.ReactNode; allowedRoles: ('super_admin' | 'admin' | 'kasir' | 'gudang')[] }) => {
  const user = indexdbUser.getCurrentUser();
  if (!user) {
    return <Navigate to="/login" replace />;
  }
  
  if (!allowedRoles.includes(user.role as 'super_admin' | 'admin' | 'kasir' | 'gudang')) {
        ...
        <Routes>
          ...
          <Route path="/*" element={
            <ProtectedRoute>
              <MainLayout>
                <Routes>
                  <Route path="/" element={<RoleRoute allowedRoles={['super_admin', 'admin']}><DashboardPage /></RoleRoute>} />
                  ...
                  <Route path="/reports" element={<RoleRoute allowedRoles={['super_admin', 'admin']}><ReportPage /></RoleRoute>} />
                  <Route path="/settings" element={<RoleRoute allowedRoles={['super_admin', 'admin']}><SettingsPage /></RoleRoute>} />
                  ...
                  <Route path="/expenses" element={<RoleRoute allowedRoles={['super_admin', 'admin']}><ExpensePage /></RoleRoute>} />
                  <Route path="/discounts" element={<RoleRoute allowedRoles={['super_admin', 'admin']}><DiscountPage /></RoleRoute>} />
